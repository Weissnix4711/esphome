...
CONF_BOILER_CH_SETPOINT = 'boiler_ch_setpoint'
CONF_BOILER_DHW_SETPOINT = 'boiler_dhw_setpoint'
CONF_BOILER_DHW_TEMPERATURE = 'boiler_dhw_temperature'
CONF_BOILER_FEED_TEMPERATURE = 'boiler_feed_temperature'
CONF_BOILER_FLAME_STATUS = 'boiler_flame'
CONF_BOILER_MODULATION = 'boiler_modulation'
CONF_BOILER_RETURN_WATER_TEMPERATURE = 'boiler_return_temperature'
CONF_BRANCH = 'branch'
